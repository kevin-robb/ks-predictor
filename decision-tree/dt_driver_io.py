...
def read_file(fname:str,write_readable:bool=False) -> Node:
...
print("First argument: write, read, or wr. wr reads recoverable and writes to readable.")
print("If write: Second argument: full_cat, seg_cat, full, or seg.")
print("If read or wr: Second argument: filename.")
mode = str(sys.argv[1])
if mode == "write":
    ...
    root_node = read_file(fname=str(sys.argv[2]),write_readable=True)
